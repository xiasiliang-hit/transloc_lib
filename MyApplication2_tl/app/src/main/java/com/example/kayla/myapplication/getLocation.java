...
*/
        ...
        if(!location.equals("")) {
            ...
            location = location + " UFL Gainesville";
            try {
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
              ...
              //  {
               ...
               // }
                Intent i = new Intent(getApplicationContext(),MapActivityEndStop.class);
                ...
                busManager.setStartStop( new Stop(marker.getTitle(), Double.toString(lat), Double.toString(lng), stopId, routeIdList, list));

                busManager.time = time;
