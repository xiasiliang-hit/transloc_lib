...
public class Stop implements Comparable<Stop> {
    public static final String FAVORITES_PREF = "favorites";
     ArrayList<Stop> childStops = null;
    String name, id;
    LatLng loc;
    String[] routesString;
    ...
    public Stop(String mName, String mLat, String mLng, String mID, ArrayList<String> mrouteIds, ArrayList<String> mrouteNames)
    {
        name = cleanName(mName);
        loc = new LatLng(Double.parseDouble(mLat), Double.parseDouble(mLng));
        id = mID;
        routesString = new String[32];
